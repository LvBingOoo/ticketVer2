...
//    private Animation mRotateDownAnim;
    ...
    private void initView() {
        ...
        mContainer = (LinearLayout) LayoutInflater.from(getContext()).inflate(R.layout.listview_header2, null);
...
//        mRotateDownAnim.setFillAfter(true);
    ...
    private void setPullDownAnim(){
        valueAnimator = ValueAnimator.ofInt(1, 30);
        valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                try {
                    ...
                    int id = 0;
                    if (value < 10){
                        id = getResources().getIdentifier("fumei000" + value, "drawable", getContext().getPackageName());
                    }else{
                        id = getResources().getIdentifier("fumei00" + value, "drawable", getContext().getPackageName());
                    }
