...
import com.xhh.ticketver2.ui.adapter.user.BillAdapter;
import com.xhh.ticketver2.ui.base.BaseActivity;
import com.xhh.ticketver2.ui.view.ChongTiView;

import butterknife.InjectView;

public class BillActivity extends BaseActivity implements ChongTiView, BillAdapter.onItemClickListenter {
    ...
    private void getData(){
        chongTiPresenter.postGetBill(mPage);
    }
...
//        mLRecyclerView.addItemDecoration(divider);
        ...
        adapter = new BillAdapter(mContext, mScreenWidth, this);
