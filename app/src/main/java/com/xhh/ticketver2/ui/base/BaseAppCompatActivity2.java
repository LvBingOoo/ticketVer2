...
import com.hhhc.obsessive.library.netstatus.NetChangeObserver;
import com.hhhc.obsessive.library.netstatus.NetStateReceiver;
import com.hhhc.obsessive.library.netstatus.NetUtils;
import com.hhhc.obsessive.library.utils.CommonUtils;
import com.hhhc.obsessive.library.utils.SmartBarUtils;
...
public abstract class BaseAppCompatActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        if (/*toggleOverridePendingTransition()*/true) {
            switch (/*getOverridePendingTransitionMode()*/TransitionMode.FADE) {
                case LEFT:
...
//        }
     ...
     *
     * @return schemeId of layout resource
     */
     ...
     * @param eventCenter
     */
    protected abstract void onPubEvent(EventCenter eventCenter);

    /**
     * show all views and add events
     */
