...
public class MyDialog {
     ...
     * @return
     */
    public static Dialog showTimeAlertDialog(Context mContext, int titleicon, String title, final String message,
            String positiveButton, final int time, final OnTimeAlertViewClickListener positiveListener) {
        ...
        pButton.setLayoutParams(new LayoutParams(LayoutParams.MATCH_PARENT, dip2px(mContext, 44), 1.0f));
     ...
     * @return
     */
	public static Dialog showAlertView(Context mContext, int titleicon, String title, String message,
            String positiveButton, final String[] otherButtons, final OnAlertViewClickListener positiveListener) {
		if (mContext == null) {
			return null;
		}
        ...
        if (null != otherButtons && otherButtons.length > 0) {
            for (int i = 0; i < otherButtons.length; i++) {
                ...
                otherButton.setLayoutParams(new LayoutParams(LayoutParams.MATCH_PARENT, dip2px(mContext,
                        44), 1.0f));
                ...
                if (1 == otherButtons.length) {
                    otherButton.setBackgroundResource(R.drawable.alert_right_button);
                } else if (i < (otherButtons.length - 1)) {
                    otherButton.setBackgroundResource(R.drawable.alert_middle_button);
                } else {
                    otherButton.setBackgroundResource(R.drawable.alert_bottom_button);
                }
...
//        dialog.setCancelable(false);
        ...
        int pad = new DensityUtil(mContext).dip2px(10);
