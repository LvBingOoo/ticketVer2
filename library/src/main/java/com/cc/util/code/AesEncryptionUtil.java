...
public class AesEncryptionUtil {
    ...
    public static  String getEnAesBase64(String content)  {
        byte[] result = encrypt(content.getBytes(),key,iv);
        try {
    ...
    public static  String getDeAesBase64(String content)  {
        try {
            byte[] result = Base64Utils.decode(content);
            result = decrypt(result,key,iv);
            try {
