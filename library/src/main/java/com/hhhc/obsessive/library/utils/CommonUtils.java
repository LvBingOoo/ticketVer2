...
public class CommonUtils {
     ...
     * 获取底部虚拟键盘的高度
     */
    public static int getBottomKeyboardHeight(Activity mActivity){
        int screenHeight =  getAccurateScreenDpi(mActivity)[1];
     ...
     * 获取精确的屏幕大小
     */
    public static int[] getAccurateScreenDpi(Activity mActivity)
    {
