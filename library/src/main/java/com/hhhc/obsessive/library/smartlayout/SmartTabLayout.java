 ...
 */
package com.hhhc.obsessive.library.smartlayout;
 ...
 * alternative is via the {@link com.hhhc.obsessive.library.smartlayout.SmartTabLayout.TabColorizer} interface which provides you complete control over
...
//    textView.setTypeface(Typeface.DEFAULT_BOLD);
  ...
  String noGoPage;
    NoGoPageCallBack noGoPageCallBack;
  public void setNOGoPage(String pos,NoGoPageCallBack noGoPageCallBack){
      noGoPage = pos;
      this.noGoPageCallBack = noGoPageCallBack;
  }
    public interface NoGoPageCallBack{
    ...
    public void onClick(View v) {
      for (int i = 0; i < tabStrip.getChildCount(); i++) {
        if (v == tabStrip.getChildAt(i)) {
          if (!TextUtils.isEmpty(noGoPage)){
             if (noGoPage.contains(i+"")&&noGoPageCallBack!=null){
                 noGoPageCallBack.noGoPageCallBack(i);
             }else{
                 if (onTabClickListener != null) {
                     onTabClickListener.onTabClicked(i);
                 }
                 viewPager.setCurrentItem(i);
               if (noGoPageCallBack != null){
                 noGoPageCallBack.clickCallBack(i);
               }
             }
          }else{
            if (onTabClickListener != null) {
